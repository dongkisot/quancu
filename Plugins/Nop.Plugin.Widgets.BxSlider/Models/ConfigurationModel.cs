...
namespace Nop.Plugin.Widgets.BxSlider.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Widgets.BxSlider.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.BxSlider.Text")]
        [AllowHtml]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.BxSlider.Link")]
        [AllowHtml]
